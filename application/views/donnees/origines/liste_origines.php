...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="fa fa-database fa-fw"></i> <?php echo $this->lang->line('donnees-title');?> > <i class="fa fa-globe fa-fw"></i> <?php echo $this->lang->line('menu-origines');?> > <?php echo $this->lang->line('origines-title-liste');?>
                        	<div class="pull-right">
                        		<button class="btn btn-success btn-sm mod-edit" data-href="<?php echo base_url();?>donnees/editer_origine" data-title="<?php echo $this->lang->line('origine-title-add');?>"><i class="fa fa-plus-circle"></i> &nbsp;<?php echo $this->lang->line('origine-title-add');?></button>
                        	</div>
                        </h3>
                    </div>
                    <!-- /.col-lg-12 -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-globe fa-fw"></i> <?php echo $this->lang->line('origines-title-liste');?>
        							...
        							<li class="dropdown special-dropdown"> 
							            ...
							            <ul class="dropdown-menu mega-dropdown-menu">
	                            			...
	                            			<div class="checkbox" style="padding-left:15px;">
	                            				<label><input class="form-group check-cols" type="checkbox" name="colonnes" checked="checked" value="0"> <?php echo $this->lang->line('origines-cols0-name');?></label>
	                            			</div>
	                            		</li>
	                            		<li>
	                            			<div class="checkbox" style="padding-left:15px;">
	                            				<label><input class="form-group check-cols" type="checkbox" name="colonnes" checked="checked" value="1"> <?php echo $this->lang->line('origines-cols1-name');?></label>
	                            			</div>
	                            		</li>
	                            		<li>
	                            			<div class="checkbox" style="padding-left:15px;">
	                            				<label><input class="form-group check-cols" type="checkbox" name="colonnes" checked="checked" value="2"> <?php echo $this->lang->line('origines-cols2-name');?></label>
	                            			</div>
	                            		</li>
	                            		<li>
	                            			<div class="checkbox" style="padding-left:15px;">
	                            				<label><input class="form-group check-cols" type="checkbox" name="colonnes" checked="checked" value="3"> <?php echo $this->lang->line('origines-cols3-name');?></label>
	                            			</div>
	                            		</li>
	                            		<li>
	                            			<div class="checkbox" style="padding-left:15px;">
	                            				<label><input class="form-group check-cols" type="checkbox" name="colonnes" checked="checked" value="4"> <?php echo $this->lang->line('origines-cols4-name');?></label>
	                            			</div>
	                            		</li>
							            </ul>
							        </li>
                        ...
                        <?php if($msg=="delok"){?>
                        	 <div class="alert alert-success">
                               	<?php echo $this->lang->line('origine-msg-delok');?>
                            </div>
                            <?php }?>
                            <div class="dataTable_wrapper" style="padding-top:10px;">
                                <table class="table table-striped table-bordered table-hover display" id="dataTables-origine">
                                    <thead>
                                        <tr>
                                            <th width="5%"><?php echo $this->lang->line('origines-cols0-name');?></th>
                                            <th width="25%"><?php echo $this->lang->line('origines-cols2-name');?></th>
                                            <th width="13%"><?php echo $this->lang->line('origines-cols1-name');?></th>
                                            <th width="35%"><?php echo $this->lang->line('origines-cols3-name');?></th>
                                            <th width="12%"><?php echo $this->lang->line('origines-cols4-name');?></th>
                                    ...
                                    <tbody>
	                                	...
	                                	?>
	                                		<tr class="odd gradeX">
	                                            <td style="white-space: nowrap"><?php echo $origine->CODE_ORIGIN ; ?></td>
	                                            <td style="white-space: nowrap"><?php echo $origine->NAME_ORIGIN ; ?></td>
	                                            <td style="white-space: nowrap"><?php echo $origine->TYPE_ORIGIN ; ?></td>
	                                            <td style="white-space: nowrap"><?php echo $origine->DESC_ORIGIN ; ?></td>
	                                            <td style="white-space: nowrap"><?php echo $origine->PREFIX_ORIGIN ; ?></td>
	                                            <td style="white-space: nowrap" class="center">
	                                            	<a class="btn btn-warning btn-xs mod-edit" data-href="<?php echo base_url();?>donnees/editer_origine/<?php echo $origine->CODE_ORIGIN ; ?>" data-title="<?php echo $this->lang->line('origine-title-edit')." ".$origine->NAME_ORIGIN ; ?>"><i class="fa fa-pencil fa-fw"></i></a>
	                                            	<a data-toggle="modal" data-target="#myModal<?php echo $origine->CODE_ORIGIN ; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash fa-fw"></i></a>
	                                            	<!-- Modal -->
						                            <div class="modal fade" id="myModal<?php echo $origine->CODE_ORIGIN ; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						                                <div class="modal-dialog">
						                                    <div class="modal-content">
						                                        <div class="modal-header">
						                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						                                            <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('origine-modal-del-title');?></h4>
						                                        </div>
						                                        <div class="modal-body">
						                                            <?php echo $this->lang->line('origine-modal-del-txt');?> <strong><?php echo $origine->NAME_ORIGIN ; ?></strong> !
						                                        </div>
						                                        <div class="modal-footer">
						                                            <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $this->lang->line('liste-close');?></button>
						                                            <a type="button" class="btn btn-danger" href="<?php echo base_url();?>donnees/supprimer_origine/<?php echo $origine->CODE_ORIGIN ; ?>"><i class="fa fa-trash fa-fw"></i> <?php echo $this->lang->line('liste-del');?></a>
						                                        </div>
						                                    </div>
						                                    <!-- /.modal-content -->
						                                </div>
    ...
    $(document).ready(function() {
        var table = $('#dataTables-origine').DataTable({
                responsive: true,
                "language": {

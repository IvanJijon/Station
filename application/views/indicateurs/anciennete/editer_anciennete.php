<form action="<?php echo base_url();?>indicateurs/editer_anciennete/<?php echo $infoAnciennete->SEN_CODE;?>" id="formAnciennete" method="post">
...
<script>
	function verifName(){
		if($('#SEN_NAME').val()!=""){				
			$.post('<?php echo base_url()?>indicateurs/check_name_anciennete/<?php echo $infoAnciennete->SEN_CODE;?>',{SEN_NAME:$('#SEN_NAME').val()},function(data){
				if(data=="true"){					

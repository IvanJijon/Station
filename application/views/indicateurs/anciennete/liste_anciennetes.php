    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="fa fa-list fa-fw"></i> <?php echo $this->lang->line('indicateurs-title');?> > <i class="fa fa-university fa-fw"></i> <?php echo $this->lang->line('anciennete-title');?> > <?php echo $this->lang->line('anciennete-title-liste');?>
                        	<div class="pull-right">
                        		<button class="btn btn-success btn-sm mod-edit" data-href="<?php echo base_url();?>indicateurs/editer_anciennete" data-title="<?php echo $this->lang->line('anciennete-title-add');?>"><i class="fa fa-plus-circle"></i> &nbsp;<?php echo $this->lang->line('anciennete-title-add');?></button>
                        	</div>
                        </h3>
                    </div>
                    <!-- /.col-lg-12 -->
	                                	...
	                                	?>
	                                		<tr class="odd gradeX">
	                                            ...
	                                            <td style="white-space: nowrap" class="center">
	                                            	<a class="btn btn-warning btn-xs mod-edit" data-href="<?php echo base_url();?>indicateurs/editer_anciennete/<?php echo $anciennete->SEN_CODE ; ?>" data-title="<?php echo $this->lang->line('anciennete-title-edit')." ".$anciennete->SEN_NAME ; ?>"><i class="fa fa-pencil fa-fw"></i></a>
						                                ...
						                                <div class="modal-dialog">
						                                    <div class="modal-content">
						                                        ...
						                                        <div class="modal-footer">
						                                            ...
						                                            <a type="button" class="btn btn-danger" href="<?php echo base_url();?>indicateurs/supprimer_anciennete/<?php echo $anciennete->SEN_CODE ; ?>"><i class="fa fa-trash fa-fw"></i> <?php echo $this->lang->line('liste-del');?></a>
						                                        </div>
						                                    </div>
						                                    <!-- /.modal-content -->
						                                </div>

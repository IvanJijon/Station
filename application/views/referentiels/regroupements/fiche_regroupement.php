...
<body>
	                        ...
	                        <div class="panel-body">
		                        <br/>
			                        <table class="table table-striped table-bordered table-hover display" id="table-rules">
										...
										<tfoot>
	                                    	<tr>
												<!-- /!\ Pour les filtres il est très important qu'il y ait autant de "<th></th>" que de colonnes !! /!\ -->
	                                    		<th></th>
		                       					<?php
	                                    		foreach($tabChampsRules['SRC'] as $nbRule){?>
	                                    			<th><input type="text" placeholder="Filtre..." /></th>
	                                    		<?php }
	                                    		foreach($tabChampsRules['EXT'] as $nbRule){?>
	                                    			<th><input type="text" placeholder="Filtre..." /></th>
	                                    		<?php }?>
	...
	<!-- DataTables 1.10.4 JavaScript -->	
    <!-- <script src="<?php echo URL_PLUGINS; ?>datatables/media/js/jquery.dataTables.min.js"></script> -->
    
	<!-- DataTables 1.10.6 JavaScript -->	
	<script src="<?php echo URL_PLUGINS; ?>datatables/media/js/jquery.dataTables.1.10.6.min.js"></script>
	...
	<script>
		$(document).ready(function(){
			...
			table.columns().every(function () {
				// On récupère la colonne sur laquelle on itère
				var col = this;

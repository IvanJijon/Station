...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="fa fa-lock fa-fw"></i> <?php echo $this->lang->line('menu-securite');?> > <i class="fa fa-users fa-fw"></i> <?php echo $this->lang->line('menu-securite-utilisateurs');?> > <?php echo $this->lang->line('securite-title-liste-utilisateurs');?>
                        	<div class="pull-right">
                        		<button class="btn btn-success btn-sm mod-edit" data-href="<?php echo base_url();?>securite/editer_utilisateur" data-title="<?php echo $this->lang->line('utilisateur-title-add');?>"><i class="fa fa-plus-circle"></i> &nbsp;<?php echo $this->lang->line('utilisateur-title-add');?></button>
                        	</div>
                        </h3>
                    </div>
                    <!-- /.col-lg-12 -->
	                ...
	                <div class="col-lg-12">
	                    <div class="panel panel-default">
	                        <div class="panel-heading">
	                            <i class="fa fa-users fa-fw"></i> <?php echo $this->lang->line('securite-title-liste-utilisateurs');?>
							            ...
							            <ul class="dropdown-menu mega-dropdown-menu">
							                <li>
		                            			<div class="checkbox" style="padding-left:15px;">
		                            				<label><input class="form-group check-cols" type="checkbox" name="colonnes" checked="checked" id="champs-0" value="0"> <?php echo $this->lang->line('utilisateur-cols0-name');?></label>
		                            			</div>
	                    					</li>
	                    					<li>
		                            			<div class="checkbox" style="padding-left:15px;">
		                            				<label><input class="form-group check-cols" type="checkbox" name="colonnes" checked="checked" id="champs-1" value="1"> <?php echo $this->lang->line('utilisateur-cols1-name');?></label>
		                            			</div>
	                    					</li>
		                            		<li>
		                            			<div class="checkbox" style="padding-left:15px;">
		                            				<label><input class="form-group check-cols" type="checkbox" name="colonnes" checked="checked" id="champs-2" value="2"> <?php echo $this->lang->line('utilisateur-cols2-name');?></label>
		                            			</div>
		                            		</li>
							            </ul>
							        </li>
	                        ...
	                        <?php if($msg=="delok"){?>
	                        	 <div class="alert alert-success">
	                               	<?php echo $this->lang->line('utilisateur-msg-delok');?>
	                            </div>
	                            <?php }?>
	                            <div class="dataTable_wrapper" style="padding-top:10px;">
	                                <table class="table table-striped table-bordered table-hover display" id="dataTables-utilisateurs">
	                                    <thead>
	                                        <tr>
	                                            <th><?php echo $this->lang->line('utilisateur-cols0-name');?></th>
	                                            <th><?php echo $this->lang->line('utilisateur-cols1-name');?></th>
	                                            <th><?php echo $this->lang->line('utilisateur-cols2-name');?></th>
	                                    ...
	                                    <tbody>
		                                	...
		                                	?>
		                                		<tr class="odd gradeX">
		                                            ...
		                                            <td style="white-space: nowrap"><?php echo $user->NAME_PROFILE ; ?></td>
		                                            <td style="white-space: nowrap" class="center">
		                                            	<a class="btn btn-warning btn-xs mod-edit" data-href="<?php echo base_url();?>securite/editer_utilisateur/<?php echo $user->CODE_USER ; ?>" data-title="<?php echo $this->lang->line('utilisateur-title-edit')." ".$user->USERNAME ; ?>"><i class="fa fa-pencil fa-fw"></i> </a>
		                                            	<a data-toggle="modal" data-target="#myModal<?php echo $user->CODE_USER ; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash fa-fw"></i> </a>
		                                            	<!-- Modal -->
							                            <div class="modal fade" id="myModal<?php echo $user->CODE_USER ; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							                                <div class="modal-dialog">
							                                    <div class="modal-content">
							                                        <div class="modal-header">
							                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
							                                            <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('utilisateur-modal-del-title');?></h4>
							                                        </div>
							                                        <div class="modal-body">
							                                            <?php echo $this->lang->line('utilisateur-modal-del-txt');?> <strong><?php echo $user->USERNAME ; ?></strong> !
							                                        </div>
							                                        <div class="modal-footer">
							                                            <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $this->lang->line('liste-close');?></button>
							                                            <a type="button" class="btn btn-danger" href="<?php echo base_url();?>securite/supprimer_utilisateur/<?php echo $user->CODE_USER ; ?>"><i class="fa fa-trash fa-fw"></i> <?php echo $this->lang->line('liste-del');?></a>
							                                        </div>
							                                    </div>
							                                    <!-- /.modal-content -->
							                                </div>
    ...
    $(document).ready(function() {
        var table = $('#dataTables-utilisateurs').DataTable({
                responsive: true,
                "language": {
        ...
        $('#dataTables-utilisateurs').on('draw.dt', function ( e, settings) {
        ...
        $(".check-cols").click(function(){
			if($(this).is(':checked')){
				$('#dataTables-example').DataTable().column($(this).val()).visible(true);
			}else{
				$('#dataTables-example').DataTable().column($(this).val()).visible(false);
			}
        });
    });
